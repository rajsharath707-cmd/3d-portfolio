...
const TechStack = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const targetEl = document.getElementById("work") || document.getElementById("education");
            if (!targetEl)
                return;
